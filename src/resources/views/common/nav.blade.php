  ...
  <div class="container-fluid">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <form class="form-inline" id="search-form" method="GET" action="{{ route('event.index') }}">
        ...
        <input class="form-control mr-sm-2 d-inline" id="search-input" type="search" name="search" placeholder="キーワードを入力" value="{{ isset($word) ? $word : '' }}">
        <button class="btn btn-outline-success my-2 my-sm-0 d-inline" type="submit">検索</button>
        </form>
      </div>
  </div>
</nav>
